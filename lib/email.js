    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background: linear-gradient(135deg, #ff6600, #ff8533); color: white; padding: 20px; text-align: center; border-radius: 10px 10px 0 0;">
          <h1 style="margin: 0; font-size: 24px;">ClicksandTypes</h1>
        ...
        <div style="background: #f9f9f9; padding: 20px; border-radius: 0 0 10px 10px;">
          ...
          <div style="background: white; padding: 15px; border-radius: 8px; margin-bottom: 20px;">
            ...
            <div style="display: flex; justify-content: space-between; margin: 5px 0;">
              <span>Subtotal:</span>
              <span>₱${orderData.subtotal || orderData.amount}</span>
            </div>
            <div style="display: flex; justify-content: space-between; margin: 5px 0;">
              <span>Tax (12%):</span>
            ...
            <div style="display: flex; justify-content: space-between; margin: 5px 0;">
              <span>Shipping:</span>
              <span>${orderData.shippingFee === 0 ? 'FREE' : '₱' + (orderData.shippingFee || 0)}</span>
            </div>
            <div style="display: flex; justify-content: space-between; margin: 10px 0; padding-top: 10px; border-top: 2px solid #ff6600; font-weight: bold; font-size: 18px;">
              <span>Total:</span>
              <span>₱${orderData.totalAmount || orderData.amount}</span>
            </div>
          </div>
          ...
          <div style="text-align: center; margin-top: 20px; color: #666; font-size: 14px;">
            ...
            <p>Thank you for choosing ClicksandTypes!</p>
          </div>
        </div>
      </div>
    `
