                    ...
                    <div className="flex items-center justify-between w-full mb-6">
                        <div className="flex items-center gap-4">
                            <div className="flex items-center gap-3">
                                <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center">
                                    <FaKeyboard className="w-6 h-6 text-green-600" />
                                </div>
                                <div className="flex flex-col items-start">
                                    <h1 className="text-3xl font-bold text-gray-900">Gaming Keyboards</h1>
                                    <p className="text-gray-600">Responsive keys for ultimate gaming performance</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-4">
                            <span className="text-sm text-gray-600">
                                {filteredProducts.length} keyboard{filteredProducts.length !== 1 ? 's' : ''} found
                            </span>
                            {hasActiveFilters && (
                                <button
                ...
                <div className="w-full">
                    {isLoading ? (
                        <div className="flex justify-center items-center py-20">
                            <Loading size="large" text="Filtering keyboards..." />
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center py-20 text-center">
                            <div className="w-24 h-24 bg-green-100 rounded-full flex items-center justify-center mb-4">
                                <FaKeyboard className="w-8 h-8 text-green-400" />
                            </div>
                            ...
                            <button
                                onClick={clearFilters}
                                className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors duration-200 ease-out"
                            >
                                Clear all filters
                            </button>
                        </div>
...
const KeyboardProducts = () => {
    return (
        <Suspense fallback={<Loading size="large" text="Loading keyboards..." />}>
            <KeyboardProductsContent />
        </Suspense>
    );
};
